...
namespace CheruKayil_Polymers
{
    public partial class Cutomer : Form
    {
        ...
        private void grdShow()
        {
            ...
            string sql = "SELECT cname as Name, cadd as Address, cplace as Place, cphone1 as Phone1 , cphone2 as Phone2, mob as Mobil, ctin as TinNumber, mail as Mail FROM customer";
            SqlConnection connection = new SqlConnection(connetionString);
            SqlDataAdapter dataadapter = new SqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
        ...
        private void addRow()
        {
            ...
            sql = "insert into customer(cname,cadd,cplace,cphone1,cphone2,mob,ctin,mail) values('" + name + "','" + add + "','" + place + "','" + ph1 + "','" + ph2 + "','" + mob + "','" + tin + "','" + mail + "')";
        ...
        private void updaterow()
        {
            ...
            sql = "update customer set cname = '" + name + "' ,cadd=' " + add + "' ,cplace='" + place + "' ,cphone1='" + ph1 + "' ,cphone2='" + ph2 + "' ,mob='" + mob + "' ,ctin='" + tin + "' ,mail='" + mail + "' where cname like '" + name + "'";
        ...
        private void delrow()
        {
            ...
            if (rst == DialogResult.Yes)
            {
                ...
                //MessageBox.Show(sql.ToString());
                sql = "delete from customer where cname like '" + name + "'";
        ...
        private void comboBox1_TextChanged(object sender, EventArgs e)
        {
            ...
            string sql = "SELECT cname as Name, cadd as Address, cplace as Place, cphone1 as Phone1 , cphone2 as Phone2, mob as Mobil, ctin as TinNumber, mail as Mail FROM customer where cname='" + name + "';";
            SqlConnection connection = new SqlConnection(connetionString);
            SqlDataAdapter dataadapter = new SqlDataAdapter(sql, connection);
            DataSet ds = new DataSet();
